...
public sealed class RichTextColumns: Panel {
	...
	/// </summary>
	public static DependencyProperty RichTextContentProperty { get; } = DependencyProperty.Register(
		nameof(RichTextContent),
		typeof(RichTextBlock),
		typeof(RichTextColumns), new PropertyMetadata(defaultValue: null, ResetOverflowLayout));

	/// <summary>
	/// Identifies the <see cref="ColumnTemplate"/> dependency property.
	/// </summary>
	public static DependencyProperty ColumnTemplateProperty { get; } = DependencyProperty.Register(
	...
	public RichTextBlock? RichTextContent {
		get => (RichTextBlock?)this.GetValue(RichTextContentProperty);
	...
	public DataTemplate? ColumnTemplate {
		get => (DataTemplate?)this.GetValue(ColumnTemplateProperty);
	...
	static void ResetOverflowLayout(DependencyObject d, DependencyPropertyChangedEventArgs e) {
		...
		if (d is RichTextColumns target) {
	...
	/// RichTextBlock child.
	/// </summary>
	List<RichTextBlockOverflow>? overflowColumns;
